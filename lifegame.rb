...
lifes = Lifegame.new(ARGV[0].to_i, ARGV[1].to_i)

# グライダー
#lifes[2,7].be!; lifes[2,8].be!; lifes[2,9].be!; lifes[1,7].be!; lifes[0,8].be!

# 直線
#lifes[4,3].be!; lifes[4,4].be!; lifes[4,5].be!; lifes[4,6].be!; lifes[4,7].be!;

lifes.sow!((ARGV[2] || 0.2).to_f)
lifes.start
